...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h1 class="text-center mb-3"> Enter your true informations to register</h1>
            <form:form action="register-user" method="POST"  modelAttribute="crmUser">
                <div class="row">
                ...
                <div class="mb-3">
                   <%----%> <%--<spring:message code="Enter name" var="placeholder"/>--%>
